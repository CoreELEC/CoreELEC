...
def main(args):
    ...
    try:
        ...
        callExternalScripts("/emuelec/system/scripts", "gameStart", [systemName, system.config['emulator'], system.config["core"], args.rom])

        # run the emulator
        exitCode = runCommand(generators[system.config['emulator']].generate(system, args.rom, playersControllers, gameResolution))

        # run a script after emulator shuts down
        callExternalScripts("/emuelec/system/scripts", "gameStop", [systemName, system.config['emulator'], system.config["core"], args.rom])
