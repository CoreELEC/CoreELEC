...
class Emulator():
    ...
    def __init__(self, name, rom):
        ...
        self.config = Emulator.get_system_config(self.name, "/storage/.config/emuelec/configs/configgen-defaults.yml", "/storage/.config/emuelec/configs/configgen-defaults-emuelec.yml")
        ...
        # load configuration from emuelec.conf
        ...
        if "shaderset" in self.config and self.config["shaderset"] != "none":
            self.renderconfig = Emulator.get_generic_config(self.name, "/storage/.config/emuelec/configs/shaders/configs/" + self.config["shaderset"] + "/rendering-defaults.yml", "/storage/.config/emuelec/configs/shaders/configs/" + self.config["shaderset"] + "/rendering-defaults-arch.yml")
        if "shaderset" not in self.config: # auto
            self.renderconfig = Emulator.get_generic_config(self.name, "/storage/.config/emuelec/configs/shaders/configs/rendering-defaults.yml", "/storage/.config/emuelec/configs/shaders/configs/rendering-defaults-arch.yml")
    ...
    def get_system_config(system, defaultyml, defaultarchyml):
        ...
        # it is flat in the emuelec.conf which is easier for the end user, but i prefer not flat in the yml files
