...
class Emulator():
    ...
    def __init__(self, name, rom):
        ...
        if "shaderset" in self.config and self.config["shaderset"] != "none":
            self.renderconfig = Emulator.get_generic_config(self.name, "/storage/.config/emuelec/shaders/configs/" + self.config["shaderset"] + "/rendering-defaults.yml", "/storage/.config/emuelec/configs/shaders/configs/" + self.config["shaderset"] + "/rendering-defaults-arch.yml")
