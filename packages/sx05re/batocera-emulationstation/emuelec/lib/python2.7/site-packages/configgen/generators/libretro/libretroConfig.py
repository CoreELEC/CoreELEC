...
def createLibretroConfig(system, controllers, rom, bezel, gameResolution):
    ...
    if 'shader' in renderConfig and renderConfig['shader'] != None:
        ...
        if os.path.exists("/tmp/shaders/" + shaderFilename):
            retroarchConfig['video_shader_dir'] = "/tmp/shaders"
            eslog.log("shader {} found in /tmp/shaders".format(shaderFilename))
        else:
            retroarchConfig['video_shader_dir'] = "/tmp/shaders"
    ...
    if gameResolution["width"] < 400 and gameResolution["height"] < 400:
        ...
        retroarchConfig['assets_directory'] = '/tmp/assets'
