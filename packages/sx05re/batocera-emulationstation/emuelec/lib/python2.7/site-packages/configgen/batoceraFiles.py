#!/usr/bin/env python
HOME_INIT = '/storage/.config/emuelec/configs/datainit/system/'
HOME = '/storage/.config/emuelec'
CONF_INIT = HOME_INIT + '/configs'
CONF = HOME + '/configs'
SAVES = '/storage/.config/emuelec/saves'
SCREENSHOTS = '/storage/.config/emuelec/screenshots'
BIOS = '/storage/roms/bios'
OVERLAYS = '/tmp/overlays'
CACHE = '/tmp/cache'

esInputs = '/storage/.emulationstation/es_input.cfg'
esSettings = '/storage/.emulationstation/es_settings.cfg'
batoceraConf = CONF + '/batocera.conf'
logdir = HOME + '/logs/'
...
retroarchCores = "/tmp/cores/"
libretroExt = '_libretro.so'
screenshotsDir = SCREENSHOTS
savesDir = SAVES + "/libretro"
...
reicastBios = BIOS + "/dc"
reicastVMUBlank = '/emuelec/lib/python2.7/site-packages/configgen/datainit/reicast/vmu_save_blank.bin'
...
overlayUser = "/emuelec/decorations"
overlayConfigFile = "/emuelec/system/configs/retroarch/overlay.cfg"
